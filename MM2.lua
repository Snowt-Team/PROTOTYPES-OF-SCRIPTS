...
-- Teleport Tab (Reworked with Save, TP, and Copy Coordinates)
...
-- Helper: Teleport to Lobby (Optimized)
local function TeleportToLobby()
    ...
    local localRoot = GetHumanoidRootPart(LocalPlayer)
    if localRoot then
        localRoot.CFrame = CFrame.new(spawnPoint.Position + Vector3.new(0, Config.TeleportOffset, 0))
